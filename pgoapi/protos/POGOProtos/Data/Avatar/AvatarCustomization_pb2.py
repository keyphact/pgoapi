...
AvatarCustomization = _reflection.GeneratedProtocolMessageType('AvatarCustomization', (_message.Message,), dict(
  ...
  __module__ = 'POGOProtos.Data.Avatar.AvatarCustomization_pb2'
