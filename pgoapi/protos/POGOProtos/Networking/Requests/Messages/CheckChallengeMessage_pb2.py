...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='POGOProtos/Networking/Requests/Messages/CheckChallengeMessage.proto',
  package='POGOProtos.Networking.Requests.Messages',
  syntax='proto3',
  serialized_pb=_b('\nCPOGOProtos/Networking/Requests/Messages/CheckChallengeMessage.proto\x12\'POGOProtos.Networking.Requests.Messages\".\n\x15\x43heckChallengeMessage\x12\x15\n\rdebug_request\x18\x01 \x01(\x08\x62\x06proto3')
)
...
CheckChallengeMessage = _reflection.GeneratedProtocolMessageType('CheckChallengeMessage', (_message.Message,), dict(
  ...
  __module__ = 'POGOProtos.Networking.Requests.Messages.CheckChallengeMessage_pb2'
