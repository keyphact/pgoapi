...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='POGOProtos/Networking/Requests/Messages/GetBuddyWalkedMessage.proto',
  package='POGOProtos.Networking.Requests.Messages',
  syntax='proto3',
  serialized_pb=_b('\nCPOGOProtos/Networking/Requests/Messages/GetBuddyWalkedMessage.proto\x12\'POGOProtos.Networking.Requests.Messages\"\x17\n\x15GetBuddyWalkedMessageb\x06proto3')
)
...
GetBuddyWalkedMessage = _reflection.GeneratedProtocolMessageType('GetBuddyWalkedMessage', (_message.Message,), dict(
  ...
  __module__ = 'POGOProtos.Networking.Requests.Messages.GetBuddyWalkedMessage_pb2'
