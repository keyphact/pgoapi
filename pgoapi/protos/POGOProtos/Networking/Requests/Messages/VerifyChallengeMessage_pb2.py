...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='POGOProtos/Networking/Requests/Messages/VerifyChallengeMessage.proto',
  package='POGOProtos.Networking.Requests.Messages',
  syntax='proto3',
  serialized_pb=_b('\nDPOGOProtos/Networking/Requests/Messages/VerifyChallengeMessage.proto\x12\'POGOProtos.Networking.Requests.Messages\"\'\n\x16VerifyChallengeMessage\x12\r\n\x05token\x18\x01 \x01(\tb\x06proto3')
)
...
VerifyChallengeMessage = _reflection.GeneratedProtocolMessageType('VerifyChallengeMessage', (_message.Message,), dict(
  ...
  __module__ = 'POGOProtos.Networking.Requests.Messages.VerifyChallengeMessage_pb2'
