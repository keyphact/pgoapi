...
FestivalSettings = _reflection.GeneratedProtocolMessageType('FestivalSettings', (_message.Message,), dict(
  ...
  __module__ = 'POGOProtos.Settings.FestivalSettings_pb2'
