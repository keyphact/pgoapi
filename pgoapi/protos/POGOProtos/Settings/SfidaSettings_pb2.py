...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='POGOProtos/Settings/SfidaSettings.proto',
  package='POGOProtos.Settings',
  syntax='proto3',
  serialized_pb=_b('\n\'POGOProtos/Settings/SfidaSettings.proto\x12\x13POGOProtos.Settings\".\n\rSfidaSettings\x12\x1d\n\x15low_battery_threshold\x18\x01 \x01(\x02\x62\x06proto3')
)
...
SfidaSettings = _reflection.GeneratedProtocolMessageType('SfidaSettings', (_message.Message,), dict(
  ...
  __module__ = 'POGOProtos.Settings.SfidaSettings_pb2'
